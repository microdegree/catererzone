...
var CatererController = require('./controller/AdminController');
app.use('/api/admin', CatererController);

var UserController = require('./controller/ConsumerController');
app.use('/api/consumer', UserController);
