...
import UserDashContainer from '../../Dashboard/User/UserDashContainer';
import CatererDashContainer from '../../Dashboard/Caterer/CatererDashContainer';
    ...
    return (
        <div>
            ...
            <Switch>
                ...
                <PrivateRoute path='/catererDashboard' component={CatererDashContainer} user={user} />
