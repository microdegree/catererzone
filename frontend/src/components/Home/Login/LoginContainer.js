...
const LoginContainer = props => {
    ...
    return (
        <div>
            ...
            <Button variant="info" onClick={() => { auth.login(() => { bypassLogin(props, 'catererRole') }); }}>ByPass Admin Login</Button>{' '} &nbsp;&nbsp;
            <Button variant="info" onClick={() => { auth.login(() => { bypassLogin(props, 'cateringUserRole') }); }}>ByPass Consumer Login</Button>{' '}
